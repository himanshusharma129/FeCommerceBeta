...
public class Farmer_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer__login);
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(c_pass.isEmpty()||c_email.isEmpty()){
                    Toast.makeText(Farmer_Login.this,"One or more fields are empty",Toast.LENGTH_SHORT).show();
                }
                else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            Intent intent=new Intent(Farmer_Login.this,MainActivity.class);
